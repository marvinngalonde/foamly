...
export default function RegisterProviderScreen() {
  ...
  const handleRegister = async () => {
    // Validation
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.phone || !formData.password || !formData.businessName || !formData.address) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.whiteCard}>
        ...
        >
          {/* Title */}
          <Text style={styles.titleText}>PROVIDER ACCOUNT</Text>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder="Sparkle Car Detailing"
              placeholderTextColor="#999"
            />
          </View>
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.signupButtonText}>Create Provider Account</Text>
            )}
          </TouchableOpacity>
